...
export const MANAGER_NAV_ITEMS: ManagerNavItemConfig[] = [
    ...
    { path: '/manager/credit/establishments', label: 'Estabelecimentos', featureKey: 'settings' },
    { path: '/manager/credit/pdv', label: 'PDV Crédito', featureKey: 'settings' },
...
export const ROUTE_PLAN_FEATURE_RULES: Array<{ pathPrefix: string; featureKey: PlanFeatureKey }> = [
    ...
    { pathPrefix: '/manager/reports/feedback', featureKey: 'reports' },
    ...
    { pathPrefix: '/manager/credit/settlements', featureKey: 'settings' },
    { pathPrefix: '/manager/settings/pdv-operators', featureKey: 'settings' },
