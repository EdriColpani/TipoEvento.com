...
const ManagerConsumptionLicenseBilling: React.FC = () => {
    ...
    const handlePay = async (chargeId?: string) => {
        ...
        try {
            const { checkoutUrl } = await startConsumptionLicenseCheckout(company.id, chargeId);
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <Card className="bg-black border-yellow-500/30 p-8 text-center">
                    <p className="text-gray-300">
                        ...
                        <strong className="text-yellow-500">consumo / licença</strong>.
                    </p>
            ...
            <div className="flex items-center justify-between mb-8 gap-4">
                <div>
                    <h1 className="text-2xl sm:text-3xl font-serif text-yellow-500 flex items-center gap-3">
                        ...
                        Licença mensal de consumo
                    </h1>
                    <p className="text-gray-400 text-sm mt-2">
                        Faturas de licença do plano consumo/licença —{' '}
            ...
            <Card className="bg-black border-yellow-500/30 mb-6">
                ...
                <CardContent className="flex flex-col sm:flex-row sm:items-center gap-3">
                    <p className="text-gray-500 text-xs flex-1">
                        Pague online pelo Mercado Pago para liberar o consumo com créditos EventFest no mês de
                        referência.
                    </p>
...
export default ManagerConsumptionLicenseBilling;
