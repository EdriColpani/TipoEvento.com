...
const Profile: React.FC = () => {
    ...
    const { data: clientTermsContract, isLoading: isLoadingClientTerms, isError: isErrorClientTerms } = useQuery({

        queryKey: ['clientTermsContract'],

        queryFn: fetchClientTerms,
    ...
    const onSubmit = async (values: z.infer<typeof profileSchema>) => {
        ...
        if (isLoadingClientTerms) {
            ...
            showError("Aguarde o carregamento dos termos e condições.");
    ...
    return (
        ...
        <ClientAccountPageShell title="Meu Perfil">
                    ...
                    <div className="bg-black/80 backdrop-blur-sm border border-yellow-500/30 rounded-2xl p-6 mb-8">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div>
                                ...
                                <p className="text-gray-400 text-xs">Contrato de Termos Aceito: <span className="text-yellow-500 font-medium">{clientTermsContract?.title || 'Nenhum'}</span></p>
                                    ...
                                    <Form {...form}>
                                        ...
                                        >
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                                ...
                                                {/* Termos do cliente (event_contracts / client_terms) */}
                                                ...
                                                {isEditing && (
                                                    ...
                                                    <div className="pt-6 border-t border-yellow-500/20">
                                                        ...
                                                        {isLoadingClientTerms && (
                                                            ...
                                                            <p className="text-gray-400 text-sm">Carregando termos do cliente...</p>

                                                        )}

                                                        {!isLoadingClientTerms && isErrorClientTerms && (

                                                            <p className="text-red-400 text-sm">Não foi possível carregar os termos. Tente novamente mais tarde.</p>
                                                        ...
                                                        {!isLoadingClientTerms && !isErrorClientTerms && clientTermsContract && (
                                                            ...
                                                            <MultiLineEditor
                                                                ...
                                                                externalContent={clientTermsContract.content}

                                                                externalTitle={clientTermsContract.title || 'Termos do cliente'}
