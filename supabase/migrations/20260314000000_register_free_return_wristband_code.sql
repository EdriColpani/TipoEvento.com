-- Inclui wristband_code (code_wristbands) no retorno da inscrição gratuita para exibir na tela e no e-mail
...
COMMENT ON FUNCTION public.register_free_event_with_wristband(uuid, text, text, int, text, text, text, text, text, text, text, text) IS 'Inscrição gratuita: reserva 1 wristband_analytics (preço R$0), retorna qr_code e wristband_code para tela e e-mail.';
