-- Vitrine/detalhes: exibir tipos counter com estoque mesmo fora da janela de vendas do lote.
-- batch_active / sales_open indicam se a compra está liberada hoje.
...
COMMENT ON FUNCTION public.get_event_ticket_availability(UUID) IS
  'Tipos de ingresso para vitrine/checkout. Counter: lista lotes com estoque; sales_open indica janela de vendas do lote.';
