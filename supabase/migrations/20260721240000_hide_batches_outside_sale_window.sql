-- Vitrine/checkout: exibir apenas lotes dentro da janela de vendas (início e fim).
...
COMMENT ON FUNCTION public.get_event_ticket_availability(UUID) IS
  'Tipos de ingresso para vitrine/checkout. Counter: somente lotes com estoque e dentro da janela de vendas.';
