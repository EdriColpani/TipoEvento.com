-- Permite Edge (service_role) finalizar aceite com p_user_id explícito.
-- Sem isso, auth.uid() nulo bloqueava register_contract_acceptance no finalize.
...
BEGIN
  ...
  INSERT INTO public.contract_acceptances (
    ...
    v_contract.title, v_contract.content, v_hash, NULLIF(trim(p_acceptance_source), ''),
